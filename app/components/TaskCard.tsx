...
export default function TaskCard({ id, title, description, budgetLamports, taskType, paymentToken, customTokenMint, customTokenSymbol, customTokenDecimals, customTokenLogoUri, status, creatorWallet, creatorUsername, creatorProfilePic, bidCount, submissionCount, budgetRemainingLamports, heading, platform, minKloutScore, imageUrl, imageTransform, maxWinners, prizeStructure, competitionWinners, deadlineAt, createdAt, isCreator, onImageTransformSave, totalViews }: TaskCardProps) {
